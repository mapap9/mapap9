...
* **[Quantflux Engine](https://github.com/mapap9/quantflux-engine)** — Low-level quantization and matrix execution framework optimized for compressing tensor footprints, reducing hardware activation memory, and accelerating math operations under strict bit constraints. Targeting Flux Klein 4b.
* **[Pixel Art Lora (LCAH)](https://github.com/mapap9/pixel-art-lora)** — Latent Cross-Attention Adaptation Harness executing parameter-efficient fine-tuning (PEFT) across frozen 862M parameter UNet blocks (Stable Diffusion) using real-time streaming data infrastructures.
* **[Game Sprite (Diffusion) Engine](https://github.com/mapap9/game-sprite-diffusion-engine)** — A completely custom parametric 3-channel diffusion model implementing structural U-Net configurations and multi-stage joint optimization over localized image distributions.
* **[Digit Diffusion Engine](https://github.com/mapap9/digit-diffusion-engine)** — A raw PyTorch and custom implementation of a class-conditioned Parametric Number Diffusion Engine trained using the MNIST dataset, which is a dataset usually utilized for vision.
